												...
												<?php if ($item->parent_id_page == $value->id_page): ?>
													...
													<li class="list-group-item list-group-item-action position-relative" idPage="<?php echo base64_encode($item->id_page) ?>">
														...
														<?php else: ?>
															...
															<a class="bg-transparent text-dark" href="<?php echo $basePath ?>/<?php echo $item->url_page ?>">
...
<a class="bg-transparent text-dark" href="<?php echo $basePath ?>/<?php echo $value->url_page ?>">
