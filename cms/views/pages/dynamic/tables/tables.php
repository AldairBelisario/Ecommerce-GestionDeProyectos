			...
			<div class="d-lg-flex justify-content-between">
				...
				<div class="mb-3">
					...
					<?php if ($_SESSION["admin"]->rol_admin == "superadmin" || $module->editable_module == 1): ?>
						...
						<a href="<?php echo $basePath ?>/<?php echo $module->url_page ?>/manage" class="btn btn-default btn-sm rounded backColor px-3 py-2">Agregar registro
						</a>
	        				 ...
	        				 <?php if ($_SESSION["admin"]->rol_admin == "superadmin" || $module->editable_module == 1): ?>
	        					...
	        					<td class="text-center">
								    ...
								    <?php if($module->title_module == "courses"): ?>
										...
										<a href="<?php echo $basePath ?>/curriculum" class="btn btn-sm text-dark rounded me-1 p-0 border-0">
											<i class="bi bi-mortarboard-fill"></i>
										</a>
									<?php endif; ?>

		        					<a href="<?php echo $basePath ?>/<?php echo $module->url_page ?>/manage/<?php echo base64_encode($value["id_".$module->suffix_module]) ?>/copy" class="btn btn-sm text-dark rounded m-0 p-0 border-0">
		        						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-copy" viewBox="0 0 16 16">
										  <path fill-rule="evenodd" d="M4 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1h1v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1v1z"/>
										</svg>
		        					</a>
		        					<a href="<?php echo $basePath ?>/<?php echo $module->url_page ?>/manage/<?php echo base64_encode($value["id_".$module->suffix_module]) ?>" class="btn btn-sm text-primary rounded m-0 p-0 border-0">
		        						<i class="bi bi-pencil-square"></i>
		        					</a>
