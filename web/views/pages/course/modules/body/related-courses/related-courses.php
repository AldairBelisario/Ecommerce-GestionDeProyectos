<div class="compare-box view-more-parent expanded has-hide">
    <div class="compare-title">Other related courses</div>
    <div class="compare-courses-wrap">

        <div class="course-carousel carousel2 carousel_<?php echo $key ?>">
            ...
            $select = "img_course,title_course,name_instructor,score_course,price_course,url_course,date_updated_course,subtitle_course,outcomes_course,id_coupon_course,id_course"; 
                ...
                $url = "relations?rel=courses,instructors&type=course,instructor&linkTo=id_category_course,status_course&equalTo=".$course->id_category_course.",1&orderBy=id_course&orderMode=DESC&startAt=0&endAt=8&select=".$select;
                $method = "GET";
                $fields = array();
